...
class NotesController extends Controller
{
    ...
    public function store( Request $request ){
        ...
        $note->pkt = $request->pkt;
        $note->save();

        Notification::send($user, new NewNote($note));
    ...
    public function notificationNotes( Request $request){
        $note = NotesClass::findByHashidOrFail( $request->hashId );
        $note->notification()->count();
    }

    public function sumowanie_punktow(){
        //return $query->sum('pkt')->where('student_id', '=', $student_id);
        return "Hello world";
    }
